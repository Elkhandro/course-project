...
export default function GenresPage() {
  ...
  const handleDelete = async () => {
    setSaving(true);
    try {
      await deleteGenre(modal.genre.id);
      await load();
      setModal(null);
    } catch (err) {
      setError(err.response?.data?.detail || "Ошибка");
  ...
  return (
    <div className="page-content">
      ...
      <Modal
        ...
        title={modal?.mode === "add" ? "Добавить жанр" : "Редактировать жанр"}
      >
      ...
      >
        <p>
          Удалить жанр <strong>«{modal?.genre?.name}»</strong>?
        </p>
        {error && (
