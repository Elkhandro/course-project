            ...
            <tbody>
              {sales.map((s) => (
                <tr key={s.id}>
                  ...
                  <td style={{ fontWeight: 600, color: "#4A7C59" }}>
                    {fmt(s.total_price)} ₽
                  </td>
                  <td style={{ color: "#9A8878", fontSize: ".85rem" }}>
                    {fmtDate(s.sold_at)}
                  </td>
                </tr>
              ))}
          ...
          >
            ...
            >
              <div>
                ...
                <div style={{ fontSize: ".85rem", color: "#9A8878" }}>
                  {selectedBook.author.full_name}
                </div>
              </div>
            ...
            <div style={{ marginTop: 8, fontSize: ".9rem" }}>
              ...
              {form.quantity > 1 && (
                <span
                  style={{ marginLeft: 12, color: "#4A7C59", fontWeight: 600 }}
                >
                  Итого:{" "}
                  {(selectedBook.retail_price * form.quantity).toFixed(2)} ₽
                </span>
              )}
            </div>
          </div>
