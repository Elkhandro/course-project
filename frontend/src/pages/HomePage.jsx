...
const FEATURES = [
  {
    icon: "",
    title: "Каталог книг",
    text: "Удобный поиск и фильтрация по жанрам и авторам",
  },
  {
    icon: "",
    title: "Учёт продаж",
    text: "Оформление продаж с автоматическим обновлением склада",
  },
  {
    icon: "",
    title: "Заказы",
    text: "Ведение заказов на отсутствующие книги",
  },
  {
    icon: "",
    title: "Аналитика",
    text: "Статистика выручки, топ авторы и анализ цен",
  },
];
